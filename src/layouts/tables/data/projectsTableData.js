...
export default function data(outpassDetails) {
  ...
  const rows = {
    rows: outpassDetails.map((outpass) => ({
        project: <Project image={LogoAsana} name={`${outpass.student.first_name} ${outpass.student.last_name}`} />,
        budget: (
