...
export default function data(wardenDetails) {
  ...
  const Job = ({ title, description }) => (
    ...
    const rows = {
    rows: wardenDetails.map((warden) => (
     {
        author: (<Author image={team2} name={`${warden.first_name} ${warden.last_name}`} email={warden.email} />),
        function: (<Job title={warden.hostel_details.hostel_type.toUpperCase()} description={warden.hostel_details.bldg_name} />),
        status: (
          <MDTypography component="a" href="#" variant="caption" color="text" fontWeight="medium">
           {warden.hostel_details.hostel_type}
          </MDTypography>
        ),
        employed: (
          <MDTypography component="a" href="#" variant="caption" color="text" fontWeight="medium">
